...
char cUnescaped = CharUtils.Unescape(cEscaped, unescapeOptions: uOptions);
...
string eUnescaped = CharUtils.UnescapeSurrogatePair(eEscaped, unescapeOptions: uOptions);
...
let cUnescaped = CharUtils.Unescape(cEscaped, unescapeOptions = uOptions)
...
let eUnescaped = CharUtils.UnescapeSurrogatePair(eEscaped, unescapeOptions = uOptions)
...
let sUnescaped = StringUtils.Unescape(sEscaped, unescapeOptions = uOptions)
